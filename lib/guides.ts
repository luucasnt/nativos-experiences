...
export const guides: Record<string, GuideData> = {
  ...
  "festa-de-sao-sebastiao-trancoso": {
    slug: "festa-de-sao-sebastiao-trancoso",
    kicker: "GUIA · CULTURA E TRADIÇÃO",
    title: "Festa de São Sebastião em Trancoso: tradição e datas",
    seoTitle: "Festa de São Sebastião em Trancoso: Datas e Tradição 2026",
    seoDescription: "A Festa de São Sebastião acontece todo dia 19 e 20 de janeiro em Trancoso, com procissão, samba de couro e a tradicional troca do mastro. Veja como funciona.",
    intro: "Conhecida localmente como \"Viva Bastião!\", a Festa de São Sebastião é uma das celebrações mais antigas e queridas de Trancoso, misturando fé, música e tradição nativa direto no Quadrado.",
    image: "/images/tqJLnuypRYdQzANN.webp",
    imageAlt: "Quadrado histórico de Trancoso preparado para celebração tradicional",
    publishedAt: "2026-08-30",
    updatedAt: "2026-08-30",
    sections: [
      { heading: "Quando acontece", body: "A festa é celebrada todos os anos nos dias 19 e 20 de janeiro, uma data fixa no calendário — não muda de ano para ano. É uma das festividades mais tradicionais do calendário oficial de eventos de Porto Seguro, e também acontece em Caraíva." },
      { heading: "Como é a programação", body: "Tudo começa na noite do dia 19, com missa na Igreja de São João Batista, seguida pelo Samba de Couro — manifestação musical genuinamente regional — animando o Quadrado. À meia-noite, fogos de artifício marcam a virada para o dia do santo. No dia 20, a programação segue com almoço comunitário, nova missa, e uma procissão às 17h com a imagem de São Sebastião percorrendo o povoado." },
      { heading: "O momento mais aguardado: a troca do mastro", body: "O ápice da festa acontece no fim da tarde do dia 20, em frente à Igreja de São João Batista: a troca do mastro de madeira, decorado com a bandeira do santo, seguida pela tradicional \"dança do pau\". É um dos rituais mais simbólicos da cultura nativa de Trancoso, celebrado com participação intensa da comunidade local." },
    ],
    faqs: [
      { question: "Quando é a Festa de São Sebastião em Trancoso?", answer: "Todos os anos, nos dias 19 e 20 de janeiro — é uma data fixa no calendário local." },
      { question: "O que é a 'troca do mastro'?", answer: "É o ritual central da festa: um mastro de madeira decorado com a bandeira do santo é erguido em frente à Igreja de São João Batista, seguido da tradicional 'dança do pau'." },
      { question: "A festa acontece só em Trancoso?", answer: "As festividades principais ficam no Quadrado de Trancoso, mas também há celebração em Caraíva na mesma data." },
    ],
    relatedServiceSlug: "concierge-trancoso",
    relatedServiceLabel: "Planejar minha estadia durante a festa",
    relatedGuideSlugs: ["festa-de-sao-bras-e-iemanja-trancoso", "horario-do-quadrado-trancoso"],
  },

  "festa-de-sao-bras-e-iemanja-trancoso": {
    slug: "festa-de-sao-bras-e-iemanja-trancoso",
    kicker: "GUIA · CULTURA E TRADIÇÃO",
    title: "São Brás e Iemanjá em Trancoso: fé, mar e tradição",
    seoTitle: "Festa de São Brás e Iemanjá em Trancoso: Datas 2026",
    seoDescription: "Nos dias 2 e 3 de fevereiro, Trancoso celebra o padroeiro São Brás e a Festa de Iemanjá simultaneamente. Veja como funciona essa dupla tradição.",
    intro: "Poucos dias do ano concentram tanta simbologia em Trancoso quanto 2 e 3 de fevereiro — quando a devoção ao padroeiro São Brás se encontra com a homenagem à Iemanjá, rainha do mar, numa mistura única de religiosidade e cultura popular.",
    image: "/images/KIZKtHuAwdfwuLtz.webp",
    imageAlt: "Praia de Trancoso preparada para celebração tradicional à beira-mar",
    publishedAt: "2026-08-30",
    updatedAt: "2026-08-30",
    sections: [
      { heading: "Quando acontece", body: "As duas celebrações ocorrem sempre nos dias 2 e 3 de fevereiro, todos os anos, sem variação de data. São Brás é o santo padroeiro do distrito de Trancoso, e sua festa é uma das mais importantes do calendário local." },
      { heading: "Festa de Iemanjá", body: "No dia 2 de fevereiro, à beira-mar, acontece a homenagem à Iemanjá, rainha dos mares, com oferendas e rituais que reúnem diferentes tradições religiosas — uma cena bonita de se testemunhar para quem estiver na praia naquele fim de tarde." },
      { heading: "Festa de São Brás: samba de couro e a busca do mastro", body: "A programação de São Brás começa na noite do dia 2, por volta das 20h-22h, com missa e a apresentação do Samba de Couro na praça — os festeiros locais tocam e cantam até a madrugada. O momento mais aguardado é por volta das 5h da manhã do dia 3: a 'busca do mastro', quando o mastro sagrado, pintado por artistas nativos, é buscado na mata numa caminhada comunitária. Depois vem café da manhã coletivo, almoço compartilhado, nova missa à tarde, e a subida do mastro encerrando a festividade." },
      { heading: "A diferença visual entre as duas festas", body: "São Sebastião e São Brás seguem estrutura parecida, mas se diferenciam pelas cores: a Festa de São Brás usa tradicionalmente azul e branco na decoração e nas bandeiras dos mastros." },
    ],
    faqs: [
      { question: "Quando é a Festa de São Brás em Trancoso?", answer: "Nos dias 2 e 3 de fevereiro, todos os anos — mesma data da Festa de Iemanjá." },
      { question: "O que é a 'busca do mastro'?", answer: "Um ritual de madrugada (por volta das 5h do dia 3) em que a comunidade caminha até a mata para buscar o mastro sagrado, decorado pelos artistas nativos de Trancoso." },
      { question: "A Festa de Iemanjá acontece onde?", answer: "Principalmente na praia, no dia 2 de fevereiro, com oferendas ao mar ao entardecer." },
    ],
    relatedServiceSlug: "concierge-trancoso",
    relatedServiceLabel: "Planejar minha estadia durante a festa",
    relatedGuideSlugs: ["festa-de-sao-sebastiao-trancoso", "horario-do-quadrado-trancoso"],
  },

  "reveillon-em-trancoso-festas": {
    slug: "reveillon-em-trancoso-festas",
    kicker: "GUIA · RÉVEILLON",
    title: "Réveillon em Trancoso: como funcionam as grandes festas",
    seoTitle: "Réveillon em Trancoso: Guia das Festas 2026/2027",
    seoDescription: "Trancoso é um dos destinos de réveillon mais concorridos do Brasil. Entenda como funcionam as festas da Agência Haute, o Réveillon Ayumar, o Day One Trancoso e outras produções.",
    intro: "O réveillon transformou Trancoso num dos destinos de virada de ano mais concorridos do Brasil, com uma temporada de festas que vai muito além da contagem regressiva na praia. Veja como o cenário funciona.",
    image: "/images/ECIeMSBmbsoSAhwF.webp",
    imageAlt: "Praia preparada para celebração de fim de ano em Trancoso",
    publishedAt: "2026-08-30",
    updatedAt: "2026-09-10",
    sections: [
      { heading: "Quando começa a temporada", body: "A programação de festas costuma se estender de 27 de dezembro a 2 de janeiro, com eventos diferentes espalhados por essa janela — não é só a noite do dia 31. Quem viaja para o réveillon geralmente planeja ficar toda essa semana para aproveitar mais de uma festa." },
      { heading: "Agência Haute: a tradição mais antiga", body: "A Haute é a produtora mais estabelecida do réveillon de Trancoso, com um calendário de várias festas ao longo da semana — a mais tradicional é a Festa do Taípe, realizada há mais de duas décadas na Falésia de Taípe, começando à noite e seguindo até o nascer do sol do dia 1º de janeiro. O line-up completo (nomes das festas e datas exatas) muda a cada edição, então vale confirmar a programação do ano vigente." },
      { heading: "Réveillon Ayumar: a novidade do Fly Club", body: "Uma produção mais recente, o Réveillon Ayumar ocupa o Fly Club, na Praia dos Nativos, com programação ao longo de várias noites. A edição 2027 está confirmada entre 28 de dezembro de 2026 e 2 de janeiro de 2027, incluindo open bar e uma proposta de beach club diurno com bem-estar e gastronomia. Line-up e vendas ainda não abriram; a organização libera informação antecipada por grupo de WhatsApp." },
      { heading: "Day One Trancoso: virada com nascer do sol na praia", body: "Uma proposta mais recente e focada no nascer do sol, o Day One Trancoso acontece na Awe Trancoso Praia, com a virada de 31 de dezembro para 1º de janeiro construída em torno de um único conceito: celebrar a noite inteira e receber o amanhecer de frente para o mar. Line-up e ingressos para a edição 2027 ainda não foram divulgados oficialmente — a organização costuma liberar os primeiros lotes com preço mais baixo, então vale acompanhar os canais oficiais para garantir ingresso na faixa mais barata." },
      { heading: "O que saber antes de ir", body: "Hotéis e pousadas lotam rápido nessa época — quem pretende ir para o réveillon deve reservar hospedagem com bastante antecedência. Ingressos para as festas maiores também esgotam cedo e costumam ser vendidos por lote, ficando mais caros conforme a data se aproxima. Vale também planejar o transporte com antecedência, já que o movimento na região aumenta bastante nessa janela." },
    ],
    faqs: [
      { question: "Quando começa a temporada de festas de réveillon em Trancoso?", answer: "Geralmente entre 27 de dezembro e 2 de janeiro, com diferentes festas ao longo dessa semana, não só na virada." },
      { question: "Qual é a festa de réveillon mais tradicional de Trancoso?", answer: "A Festa do Taípe, promovida pela Agência Haute, é a mais antiga, realizada há mais de duas décadas na Falésia de Taípe." },
      { question: "O que é o Day One Trancoso?", answer: "Uma festa de réveillon na Awe Trancoso Praia, com conceito de virada única acompanhando o nascer do sol de 1º de janeiro. Ingressos e line-up da edição 2027 ainda não foram divulgados oficialmente." },
      { question: "Preciso reservar hospedagem com muita antecedência para o réveillon?", answer: "Sim. Hotéis e pousadas lotam rápido nessa época, assim como os ingressos das festas principais." },
    ],
    relatedServiceSlug: "casamentos-e-eventos",
    relatedServiceLabel: "Planejar meu transporte para o réveillon",
    relatedGuideSlugs: ["carnaval-em-trancoso-som-festival", "quantos-dias-ficar-em-trancoso"],
  },

  "recife-de-fora-porto-seguro-mare-baixa": {
    slug: "recife-de-fora-porto-seguro-mare-baixa",
    kicker: "GUIA · PORTO SEGURO",
    title: "Recife de Fora em Porto Seguro: por que a maré decide o passeio",
    seoTitle: "Recife de Fora Porto Seguro: Guia da Maré Baixa 2026",
    seoDescription: "Recife de Fora é a 3ª maior formação de coral do Brasil, a poucos minutos de barco de Porto Seguro. Entenda por que a maré baixa é o que faz o passeio valer a pena e quando ir esta semana.",
    intro: "A cerca de 45 minutos de barco da orla de Porto Seguro, o Recife de Fora é a terceira maior formação de coral do Brasil — e o tipo de passeio que muda completamente de figura dependendo da maré. Entenda por que isso importa e quando vale mais a pena ir.",
    image: "/images/KIZKtHuAwdfwuLtz.webp",
    imageAlt: "Piscinas naturais de coral no Recife de Fora, Porto Seguro",
    publishedAt: "2026-09-10",
    updatedAt: "2026-09-10",
    sections: [
      { heading: "O que é o Recife de Fora", body: "É um parque marinho natural formado por bancos de coral a poucos quilômetros da costa de Porto Seguro, com piscinas naturais de água cristalina onde é possível flutuar e observar peixes coloridos usando máscara e snorkel. O acesso é só de barco, com saída do cais de Porto Seguro ou da passarela de pedestres de Arraial d'Ajuda, numa travessia de 45 minutos a 1 hora." },
      { heading: "Por que a maré baixa faz toda a diferença", body: "Quanto mais baixa a maré, mais rasas e protegidas ficam as piscinas naturais formadas pelo recife — é isso que deixa a água mais calma, mais clara e mais segura para quem não é nadador experiente. Com a maré alta, o mesmo trecho fica mais fundo e mais agitado, e a experiência muda bastante. Por isso os passeios são organizados em cima da tábua de maré do dia, não de um horário fixo." },
      { heading: "Como funciona o passeio", body: "A saída de barco costuma durar de 4 a 5 horas no total, incluindo o trajeto de ida e volta e cerca de 2 a 2h30 dentro das piscinas naturais. Equipamento de snorkel geralmente está incluso. Como o horário sai da maré, não do relógio, o passeio pode começar de manhã cedo ou no meio do dia, dependendo do dia escolhido — vale confirmar com a operadora assim que decidir a data." },
      { heading: "Melhores dias para ir nesta semana", body: "Esta semana (10 a 13 de setembro) traz marés baixas bem acentuadas em Porto Seguro, na faixa de 0,2 m — uma das janelas mais favoráveis do mês para o passeio, com piscinas naturais mais rasas e melhor visibilidade. Como a maré muda todo mês, essa é só uma referência de época: o ideal é sempre confirmar a tábua de maré atualizada antes de fechar a data." },
    ],
    faqs: [
      { question: "Preciso saber nadar para ir ao Recife de Fora?", answer: "Não necessariamente — na maré baixa as piscinas naturais ficam rasas e protegidas, adequadas para quem não é nadador experiente, mas o colete costuma estar disponível para quem preferir mais segurança." },
      { question: "De onde saem os barcos para o Recife de Fora?", answer: "Do cais de Porto Seguro ou da passarela de pedestres de Arraial d'Ajuda, com travessia de 45 minutos a 1 hora até o recife." },
      { question: "Quanto tempo dura o passeio completo?", answer: "Entre 4 e 5 horas, incluindo o trajeto de barco e cerca de 2 a 2h30 dentro das piscinas naturais." },
    ],
    relatedServiceSlug: "transfer-aeroporto",
    relatedServiceLabel: "Reservar transfer no aeroporto de Porto Seguro",
    relatedGuideSlugs: ["praia-do-espelho-mare-baixa", "como-chegar-em-trancoso"],
  },

  "carnaval-em-trancoso-som-festival": {
    slug: "carnaval-em-trancoso-som-festival",
    kicker: "GUIA · CARNAVAL",
    title: "Carnaval em Trancoso e o S.O.M. Festival",
    seoTitle: "Carnaval em Trancoso: S.O.M. Festival, Guia 2026",
    seoDescription: "O S.O.M. Festival é o principal evento de carnaval em Trancoso, reunindo música eletrônica e arte por vários dias na alta temporada. Veja como funciona.",
    intro: "O carnaval em Trancoso tem uma identidade própria, bem diferente dos blocos de rua tradicionais — o destaque é o S.O.M. Festival, que transforma o vilarejo num point de música eletrônica e arte por vários dias seguidos.",
    image: "/images/allohvlHTfuVZZST.webp",
    imageAlt: "Ambiente de festa e natureza em Trancoso durante alta temporada",
    publishedAt: "2026-08-30",
    updatedAt: "2026-08-30",
    sections: [
      { heading: "O que é o S.O.M. Festival", body: "É um festival de música eletrônica e arte que acontece em Trancoso durante o período de Carnaval, reunindo DJs e artistas nacionais e internacionais em experiências imersivas — cenografia própria, 'rituais noturnos' e uma proposta que mistura música, natureza e conexão. Cada edição tem um tema conceitual diferente." },
      { heading: "Quando acontece", body: "O festival costuma durar cerca de 5 dias, sempre no período de Carnaval — como o Carnaval muda de data todo ano (segue o calendário móvel da Páscoa), as datas exatas do festival também variam. Vale confirmar a programação oficial do ano vigente antes de fechar a viagem." },
      { heading: "Diferente do carnaval tradicional", body: "Quem espera blocos de rua e marchinhas não vai encontrar isso em Trancoso — o clima do S.O.M. Festival é mais parecido com um festival de música eletrônica internacional, com formato de ingresso pago (party pass ou full pass, que pode incluir refeições) e open bar premium em algumas modalidades." },
      { heading: "Planejando a viagem", body: "Por ser um período de alta demanda — Carnaval já é temporada alta por si só, somado ao festival — hospedagem e transporte devem ser reservados com bastante antecedência. O movimento na região aumenta consideravelmente nesses dias." },
    ],
    faqs: [
      { question: "O que é o S.O.M. Festival de Trancoso?", answer: "Um festival de música eletrônica e arte realizado durante o Carnaval, com DJs nacionais e internacionais e experiências imersivas ao longo de vários dias." },
      { question: "As datas do S.O.M. Festival são sempre as mesmas?", answer: "Não. Como acompanham o período de Carnaval, que muda de data todo ano, as datas do festival variam — vale confirmar a programação oficial do ano vigente." },
      { question: "Trancoso tem carnaval de rua tradicional?", answer: "O destaque do período é o S.O.M. Festival, de perfil eletrônico e imersivo — bem diferente do formato de blocos de rua e marchinhas de outras cidades." },
    ],
    relatedServiceSlug: "passeios",
    relatedServiceLabel: "Planejar meu Carnaval em Trancoso",
    relatedGuideSlugs: ["reveillon-em-trancoso-festas", "horario-do-quadrado-trancoso"],
  },

  "calendario-de-festas-de-trancoso": {
    slug: "calendario-de-festas-de-trancoso",
    kicker: "GUIA · CULTURA E TRADIÇÃO",
    title: "Calendário de festas de Trancoso: o ano todo",
    seoTitle: "Calendário de Festas de Trancoso: Datas 2026",
    seoDescription: "Do Réveillon ao São João, veja o calendário completo das principais festas religiosas, culturais e de música de Trancoso, Bahia, com datas e o que esperar de cada uma.",
    intro: "Entre festas religiosas centenárias e festivais de música que atraem gente do Brasil inteiro, Trancoso tem um calendário de celebrações espalhado ao longo do ano inteiro. Aqui está o panorama completo, mês a mês.",
    image: "/images/tqJLnuypRYdQzANN.webp",
    imageAlt: "Quadrado histórico de Trancoso decorado para celebração",
    publishedAt: "2026-08-30",
    updatedAt: "2026-08-30",
    sections: [
      { heading: "Dezembro a janeiro: Réveillon e Festa de Reis", body: "A temporada de festas de fim de ano se estende de 27 de dezembro a 2 de janeiro, com produções como a Agência Haute e o Réveillon Ayumar. Logo depois, no dia 6 de janeiro, acontece a Festa de Reis — uma celebração folclórica mais simples, com samba de couro e boi-bumbá." },
      { heading: "19-20 de janeiro: Festa de São Sebastião", body: "Uma das festas religiosas e culturais mais tradicionais do calendário, com procissão, samba de couro e a troca do mastro em frente à Igreja de São João Batista. Data fixa todos os anos." },
      { heading: "2-3 de fevereiro: São Brás e Iemanjá", body: "Dupla celebração que mistura a devoção ao padroeiro São Brás com a homenagem à Iemanjá na praia. Inclui a tradicional 'busca do mastro' de madrugada. Data fixa todos os anos." },
      { heading: "Fevereiro ou março: Carnaval e S.O.M. Festival", body: "Como o Carnaval segue o calendário móvel da Páscoa, a data varia ano a ano. É quando acontece o S.O.M. Festival, o principal evento de música eletrônica do período em Trancoso." },
      { heading: "Junho: São João", body: "O tradicional São João também segue o formato de troca de mastro e bandeira, celebrando o santo com a mesma estrutura de fé e cultura popular das festas de janeiro e fevereiro." },
    ],
    faqs: [
      { question: "Quais festas de Trancoso têm data fixa todos os anos?", answer: "São Sebastião (19-20 de janeiro) e São Brás/Iemanjá (2-3 de fevereiro) têm datas fixas. O Carnaval e o réveillon variam conforme o calendário do ano." },
      { question: "Qual é a festa mais tradicional de Trancoso?", answer: "São Sebastião e São Brás são consideradas as festas mais tradicionais e antigas, ligadas à cultura nativa e religiosa do povoado." },
      { question: "Vale planejar a viagem em torno de uma dessas festas?", answer: "Sim, para quem quer viver o lado cultural de Trancoso além das praias. Só é importante reservar hospedagem e transporte com antecedência, já que são períodos de alta demanda." },
    ],
    relatedServiceSlug: "concierge-trancoso",
    relatedServiceLabel: "Planejar minha viagem com o concierge",
    relatedGuideSlugs: ["festa-de-sao-sebastiao-trancoso", "reveillon-em-trancoso-festas"],
  },
};
