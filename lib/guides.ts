...
export const guides: Record<string, GuideData> = {
  ...
  "reveillon-em-trancoso-festas": {
    ...
    seoDescription: "Trancoso é um dos destinos de réveillon mais concorridos do Brasil. Entenda como funcionam as festas da Agência Haute, o Réveillon Ayumar e outras produções.",
    ...
    sections: [
      ...
      { heading: "Réveillon Ayumar: a novidade do Fly Club", body: "Uma produção mais recente, o Réveillon Ayumar ocupa o Fly Club, na Praia dos Nativos, com programação de shows de grandes nomes da música brasileira ao longo de várias noites entre o fim de dezembro e o começo de janeiro, incluindo open bar e uma proposta de beach club diurno com bem-estar e gastronomia." },
