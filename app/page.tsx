...
export const metadata: Metadata = {
  title: "Transfer Porto Seguro para Trancoso e Concierge",
  description: "Transfer Porto Seguro para Trancoso, transfer privativo, motorista à disposição e concierge em Trancoso. Operação local da Nativos Experiences desde 2015.",
  ...
  openGraph: { type: "website", siteName: "Nativos Experiences", locale: "pt_BR", title: "Transfer Porto Seguro para Trancoso | Nativos Experiences", description: "Transfer privativo do Aeroporto de Porto Seguro para Trancoso, motorista à disposição e concierge local desde 2015.", url: "https://www.nativosexperiences.com/" },
  twitter: { card: "summary_large_image", title: "Transfer Porto Seguro para Trancoso | Nativos Experiences", description: "Transfer privativo, motorista à disposição e concierge em Trancoso e região da Bahia." }
};
...
export default function Home() {
  ...
  const homeFaqs = [serviceData.transfer.faqs[2], serviceData.airport.faqs[0], serviceData.armored.faqs[2]];
  ...
  const homeWebPageSchema = { "@context": "https://schema.org", "@type": "WebPage", "@id": "https://www.nativosexperiences.com/#webpage", url: "https://www.nativosexperiences.com/", name: "Transfer Porto Seguro para Trancoso e Concierge | Nativos Experiences", description: "Transfer privativo entre Porto Seguro e Trancoso, motorista à disposição, concierge, grupos e eventos em Trancoso.", isPartOf: { "@id": "https://www.nativosexperiences.com/#website" }, about: { "@id": "https://www.nativosexperiences.com/#business" }, inLanguage: "pt-BR" };

  return <main id="top" className="site-shell sand-theme">
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(homeWebPageSchema) }} />
    ...
    <section className="welcome section-light" aria-labelledby="welcome-title"><div className="section-index dark-index">N / 01</div><div className="welcome-grid"><div className="welcome-image reveal"><Image src={homeWelcomeImage} alt="Recepção privativa em Trancoso" fill sizes="(max-width: 800px) 100vw, 50vw" /><span>Uma chegada tranquila muda tudo.</span></div><div className="welcome-copy reveal"><p className="eyebrow dark"><span className="eyebrow-dot" /> Somos de Trancoso</p><h2 id="welcome-title">Você traz os planos.<br />A gente cuida <em>dos caminhos.</em></h2><p>Conhecemos o destino por dentro: aeroportos, estradas, praias, horários, acessos e o ritmo de cada época do ano. Desde 2015, a Nativos Experiences realiza transfer privativo entre Porto Seguro e Trancoso e coordena motorista à disposição, concierge, experiências, grupos e eventos na região.</p><p><a className="text-link" href="/sobre-nativos">Conheça a história da Nativos →</a></p><WhatsAppButton label="Falar com um concierge" href={wa("Olá! Gostaria de falar com um concierge da Nativos Experiences sobre minha viagem a Trancoso.")} /></div></div></section>
    ...
    <section id="avaliacoes" className="testimonials section-light" aria-labelledby="reviews-title"><div className="section-head reveal"><div><p className="eyebrow dark"><span className="eyebrow-dot" /> Experiências reais</p><h2 id="reviews-title">Quem chega com a Nativos<br /><em>entende o cuidado.</em></h2></div><p className="section-note">Veja avaliações públicas e conheça a experiência de quem já viajou com a gente.</p></div><div className="testimonial-list">{[{quote:"Equipe atenciosa, que conhece cada detalhe da região — discrição do início ao fim.",context:"Casal, setembro de 2026"},{quote:"Carro impecável, motorista atencioso e a sensação de segurança do primeiro ao último quilômetro.",context:"Viagem em família, agosto de 2025"},{quote:"Pontualidade, conforto e um atendimento que faz diferença na estadia inteira.",context:"Viagem com amigos, agosto de 2025"}].map((t)=><div className="testimonial-card reveal" key={t.context}><p>&ldquo;{t.quote}&rdquo;</p><span>{t.context}</span></div>)}</div><a className="text-link" href="https://www.tripadvisor.com.br/Attraction_Review-g303279-d33405648-Reviews-Nativos_Transfer_Trancoso-Trancoso_Porto_Seguro_State_of_Bahia.html" target="_blank" rel="noreferrer">Ver avaliações públicas no TripAdvisor</a></section>
    ...
    <section className="experiences section-light" aria-labelledby="partner-title"><div className="section-head reveal"><div><p className="eyebrow dark"><span className="eyebrow-dot" /> Para quem recebe em Trancoso</p><h2 id="partner-title">Seu hóspede chega.<br /><em>A operação já está pronta.</em></h2></div><p className="section-note">Hotéis, pousadas, villas, imobiliárias, agências, DMCs, cerimonialistas e produtoras podem contar com uma equipe local para mobilidade e concierge.</p></div><div className="experience-list"><a className="experience-card reveal" href="/parcerias"><div className="experience-info"><div><p className="card-region">PARCERIAS B2B</p><h3>Uma extensão local da experiência da sua marca.</h3></div><p className="card-description">Indicação direta ou operação como fornecedor local, conforme o modelo do parceiro.<br /><strong>Conhecer parcerias →</strong></p></div></a></div></section>
