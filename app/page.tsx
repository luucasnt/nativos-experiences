...
export default function Home() {
  ...
  return <main id="top" className="site-shell sand-theme">
    ...
    <section id="avaliacoes" className="testimonials section-light" aria-labelledby="reviews-title"><div className="section-head reveal"><div><p className="eyebrow dark"><span className="eyebrow-dot" /> Experiências reais</p><h2 id="reviews-title">Quem chega com a Nativos<br /><em>entende o cuidado.</em></h2></div><p className="section-note">Veja avaliações públicas e conheça a experiência de quem já viajou com a gente.</p></div><div className="testimonial-list">{[{quote:"Equipe atenciosa, que conhece cada detalhe da região — discrição do início ao fim.",context:"Casal, setembro de 2026"},{quote:"Carro impecável, motorista atencioso e a sensação de segurança do primeiro ao último quilômetro.",context:"Viagem em família, agosto de 2025"},{quote:"Pontualidade, conforto e um atendimento que faz diferença na estadia inteira.",context:"Viagem com amigos, agosto de 2025"}].map((t)=><div className="testimonial-card reveal" key={t.context}><p>&ldquo;{t.quote}&rdquo;</p><span>{t.context}</span></div>)}</div><a className="text-link" href="https://www.tripadvisor.com.br/Attraction_Review-g303279-d33405648-Reviews-Nativos_Transfer_Trancoso-Trancoso_Porto_Seguro_State_of_Bahia.html" target="_blank" rel="noreferrer">Ver todas as avaliações no TripAdvisor</a></section>
