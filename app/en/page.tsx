...
const routes = [
  ...
  ["Porto Seguro Airport", "Caraíva", "/en/transfer-trancoso"],
  ["Trancoso", "Caraíva", "/en/transfer-trancoso"],
  ["Trancoso", "Praia do Espelho", "/en/passeios"],
  ["Trancoso", "Arraial d’Ajuda", "/en/transfer-trancoso"]
];
...
export default function EnglishHome() {
  ...
  return <main id="top" className="site-shell sand-theme" lang="en">
    ...
    <section id="fleet" className="fleet-section section-dark" aria-labelledby="fleet-title"><div className="section-index">N / 04</div><div className="fleet-head reveal"><p className="eyebrow light"><span className="eyebrow-dot" /> The right category for every trip</p><h2 id="fleet-title">Choose the standard.<br /><em>We handle the rest.</em></h2><p>From compact categories to premium SUVs, vans and an armored Mercedes-Benz GLE 400d. The category is selected according to guests, luggage, route and comfort level; the reference model may vary with availability.</p><a className="hero-action" href="/en/frota">View the fleet</a></div></section>
